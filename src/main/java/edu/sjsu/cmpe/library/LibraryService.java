...
public class LibraryService extends Service<LibraryServiceConfiguration> {
	...
	BookResource bookRes = new BookResource(bookRepository);
	environment.addResource(bookRes);
	environment.addResource(new ReviewResource(bookRes));
	environment.addResource(new AuthorResource(bookRes));
